...
public class TabStrip3Fragment extends BaseFragment {
    ...
    public void initData() {
        ...
        mrecycleview.setLayoutManager(new StaggeredGridLayoutManager(5, StaggeredGridLayoutManager.HORIZONTAL));//设置瀑布流的样式 几列
        mrecycleview.addItemDecoration(new DividerGridItemDecoration(mContext));//划线
